...
# Predicting number of COVID Cases based on Precipitation using Decision Tree Regression
...
# Define title
plt.title("COVID Cases prediction using DTR based on Precipitation")
...
export_graphviz(DtReg, out_file='../dtregression.dot', feature_names=['Precipitation'])
