...
# Predicting number of COVID Cases based on Daylight using Decision Tree Regression
...
# Define title
plt.title("COVID Cases prediction using DTR based on Daylight")

# Define X axis
plt.xlabel('Daylight (hrs)')
...
export_graphviz(DtReg, out_file='../dtregression.dot', feature_names=['Humidity'])
