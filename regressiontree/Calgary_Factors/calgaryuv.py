...
# Predicting number of COVID Cases based on UV using Decision Tree Regression
cases_pred = DtReg.predict([[1]])
...
# Define title
plt.title("COVID Cases prediction using DTR based on UV")
